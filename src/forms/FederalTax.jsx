...
function FederalTax() {
  ...
  const [filing_status, setSelectedOptionstatus] =
    useState("Choose Pay Period");
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${BASE_URL}/User/getemployeedetails/${id}/`
        );
                ...
                <div className="shadow appearance-none border p-2 pb-4 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline grid grid-cols-4 md:grid-cols-4 divide-y-reverse sm:mx-auto sm:w-full gap-4 mb-2">
                    ...
                    >
                      ...
                      {options.map((option) => (
                        <option
                          ...
                          value={parseInt(option.employee_id, 10)}
                        >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={earnings}
                      onChange={(e) =>
                        setEarnings(parseInt(e.target.value, 10))
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setGarnishmentFees(parseInt(e.target.value))
                      }
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    >
                      <option disbale> Choose Pay Period</option>
                      <option value="single filing status">
                        {" "}
                        Single filing status
                      </option>

                      <option value="married filing sepearte return">
                        Married filing sepearte return
                      </option>
                      <option value="married filing joint return">
